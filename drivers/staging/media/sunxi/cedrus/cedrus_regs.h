...
#define VE_DEC_H265_DEC_SPS_HDR_STRONG_INTRA_SMOOTHING_ENABLE_FLAG(v) \
	((v) ? BIT(26) : 0)
#define VE_DEC_H265_DEC_SPS_HDR_SPS_TEMPORAL_MVP_ENABLE_FLAG(v) \
	((v) ? BIT(25) : 0)
...
#define VE_DEC_H265_DEC_PPS_CTRL1_LOG2_PARALLEL_MERGE_LEVEL_MINUS2(v) \
	(((v) << 8) & GENMASK(10, 8))
#define VE_DEC_H265_DEC_PPS_CTRL1_LOOP_FILTER_ACROSS_SLICES_ENABLED_FLAG(v) \
	((v) ? BIT(6) : 0)
...
#define VE_DEC_H265_SRAM_OFFSET_PIC_LIST		0x400
#define VE_DEC_H265_SRAM_OFFSET_PIC_LIST_UNIT		0x20
